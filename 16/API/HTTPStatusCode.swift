// refs. http://www.iana.org/assignments/http-status-codes/http-status-codes.xhtml
// refs. https://github.com/rhodgkins/SwiftHTTPStatusCodes/blob/master/Sources/HTTPStatusCodes.swift
//
...
public let noContent = HTTPStatusCode.noContent.rawValue
public let serviceUnavailable = HTTPStatusCode.serviceUnavailable.rawValue
public let internalServerError = HTTPStatusCode.internalServerError.rawValue
public let unauthorized = HTTPStatusCode.unauthorized.rawValue
public let notFound = HTTPStatusCode.notFound.rawValue
public let gatewayTimeout = HTTPStatusCode.gatewayTimeout.rawValue
public let badRequest = HTTPStatusCode.unauthorized.rawValue
...
@objc public enum HTTPStatusCode: Int {
    ...
    /// Early Hints: 103
    ///
    /// - seealso: [RFC-ietf-httpbis-early-hints-05](http://www.iana.org/go/rfc-ietf-httpbis-early-hints-05)
    case earlyHints = 103
...
extension Collection where Iterator.Element == HTTPStatusCode {
    public func contains(code: Int) -> Bool {
        guard let httpStatusCode = HTTPStatusCode(rawValue: code) else { return false }
        return contains(httpStatusCode)
    }
}
