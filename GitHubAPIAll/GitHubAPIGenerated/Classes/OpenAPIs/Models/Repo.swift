...
public struct Repo: Codable {
    ...
    public init(cloneUrl: String?, createdAt: String?, _description: String?, fork: Bool?, forks: Int?, forksCount: Int?, fullName: String?, gitUrl: String?, hasDownloads: Bool?, hasIssues: Bool?, hasWiki: Bool?, homepage: String?, htmlUrl: String?, _id: Int?, language: String?, masterBranch: String?, mirrorUrl: String?, name: String?, openIssues: Int?, openIssuesCount: Int?, organization: Any?, owner: Any?, parent: Any?, _private: Bool?, pushedAt: String?, size: Int?, source: Any?, sshUrl: String?, svnUrl: String?, updatedAt: String?, url: String?, watchers: Int?, watchersCount: Int?) {
